...
public class SurveyControllerTest {
    ...
    public void testGetSurveyById() throws Exception {
        ...
        //TODO: CHANGE 2 back to 1 after finishing testing
        mockMvc.perform(get("/survey/" + survey.getSurveyId())
                        .accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(content().json("{\"surveyId\":2,\"description\":\"Test Survey\",\"closed\":false,\"completions\":[],\"questions\":[{\"questionId\":0,\"question\":\"Question 1\", \"type\": \"TextQuestion\"},{\"questionId\":0,\"question\":\"Question 2\", \"type\": \"TextQuestion\"}]}"));
    }
